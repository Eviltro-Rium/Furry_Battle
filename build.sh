...
$JAVA_HOME/bin/javac -sourcepath src -d "$OUT_DIR" \
  ...
  src/Characters/RyanCharacter.java src/Characters/LeonCharacter.java \
  src/AI/AIPlayer.java src/AI/RyanAI.java src/AI/LeonAI.java \
  src/GameUI.java src/GameAnim.java src/EffectEngine.java \
  src/CharacterSelectPanel.java src/Game.java \
  src/Handlers/CharacterHandler.java src/Handlers/RyanHandler.java src/Handlers/LeonHandler.java
